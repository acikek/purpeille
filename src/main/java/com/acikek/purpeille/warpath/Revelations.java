...
public enum Revelations {
    ...
    AVARICE("avarice", Tone.TENSION, 0, ModAttributes.GENERIC_MINING_EXPERIENCE, 1.0, false, ModItems.PURPEILLE_PICKAXE),
    ...
    PACE("pace", Tone.RELEASE, 1, EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.15, true, ModItems.PURPEILLE_BOOTS),
